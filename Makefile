...
$(BUILD_DIR)/lex.yy.c: tinyc_lex.l $(BUILD_DIR)/y.tab.h
	lex -t $< > $@

$(BUILD_DIR)/lex.yy.o: $(BUILD_DIR)/lex.yy.c
	$(CC) $(CFLAGS) -Wno-unused-function -c $< -o $@

$(BUILD_DIR)/y.tab.c $(BUILD_DIR)/y.tab.h: tinyc_parse.y
...
$(BUILD_DIR)/tinyc: $(BUILD_DIR) $(BUILD_DIR)/lex.yy.o $(BUILD_DIR)/y.tab.o $(BUILD_DIR)/syntax.o $(BUILD_DIR)/environment.o $(BUILD_DIR)/assembly.o $(BUILD_DIR)/stack.o $(BUILD_DIR)/context.o $(BUILD_DIR)/list.o main.c
...
$(BUILD_DIR)/run_tests: run_tests.c $(BUILD_DIR)/tinyc
	$(CC) $(CFLAGS) $< -o $@
